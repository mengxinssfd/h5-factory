            ...
            <div class="choose-panel">
              <template v-for="comp in comps">
                <el-button
                  ...
                  round
                  :class="[
                    currentTab === 'page' && pageVal === comp.domId ? 'el-button--primary' : '',
                  ]"
...
export default {
  ...
  methods: {
    ...
    getOldVal() {
      return this.config && this.config.action.config && this.config.action.config.length
        ? this.config.action.config[this.index].click
        : null;
    },
    getCurrentTab() {
