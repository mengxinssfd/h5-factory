    ...
    <el-row>
      <el-col :span="12" style="text-align: center; width: 375px">
        <div class="area-container" v-if="areas.length" id="timesMap">
          ...
          >
            <div class="crop-box-content">
              <span class="crop-box-text" v-if="areas[3].mini" :style="getFontStyle(areas[3])">
                {{ areas[2].show ? counts.second : counts.all_second }}.{{ counts.millisecond }}
              </span>
              <span class="crop-box-text" v-else :style="getFontStyle(areas[3])">{{
              ...
              <el-form-item class="small" label="字体粗细：">
                <el-select v-model="areas[0].weight" placeholder="默认选项">
                  <template v-for="weight in mapWeight">
                    <el-option :label="weight.label" :value="weight.val"></el-option>
                  </template>
                </el-select>
              </el-form-item>
