<template>
  <div>
      ...
      <div class="form-list-panel" v-for="(input, idx) in inputs">
        ...
        <el-form-item class="small" label="表单类型：">
          <el-select v-model="input.type" placeholder="默认选项">
            <el-option v-for="opt in inputTypes" :label="opt.name" :value="opt.val"> </el-option>
          </el-select>
        </el-form-item>
        ...
        <div class="list-item-opt">
          ...
          <a href="javascript:;" v-if="idx !== inputs.length - 1" @click="downInput(idx)">
    ...
    <el-button icon="el-icon-plus" style="margin-top: 15px" round @click="addInput">
      添加表单项
    </el-button>
  </div>
</template>
